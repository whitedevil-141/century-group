...
============================== -->
    <div class="space">
            <div class="container">
                <div class="title-area text-center">
                    ...
                    <h2 class="sec-title text-theme">About Us</h2>
                ...
                <div class="row gy-40 justify-content-between align-items-center">
                    <div class="col-lg-6">
                        <div class="title-area mb-0">
                            <h2 class="sec-title text-theme mb-2">Century Group Vision & Mission</h2>
                            <p class="mb-0 text-theme">At Century Group, people are at the heart of everything we do. Whether it’s real estate, hospitality, aviation, or finance, our mission is to serve communities with integrity, trust, and innovation.</p>
                            <p class="text-theme">We are committed to creating long-term value by building sustainable businesses and inspiring lifestyles. Through transparency, professionalism, and continuous innovation, we aim to contribute to Bangladesh’s growth while enhancing the quality of life for generations to come.</p>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="img-box3">
                            ...
                            <div class="about-tag">
                                <div class="about-experience-tag">
                                    <span class="circle-title-anime">Century Group Legacy</span>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <p class="text-theme">For over three decades, Century Group has pioneered ventures across multiple industries — from real estate and housing to aviation, food, garments, tourism, and financial services.</p>
                        <p class="text-theme">Our projects, such as Century Kuakata Model Town and Century Gold Coast Resort, are designed to bring world-class experiences to Bangladesh, combining innovation with sustainability for a brighter future.</p>
                    </div>
                    <div class="col-lg-6">
                        <p class="text-theme">We believe in excellence, reliability, and responsibility. Every project we undertake is built on strong values and a vision to empower communities. As a trusted name in Bangladesh since our inception, our goal is to keep setting new benchmarks of success and service.</p>
                        <div class="about-wrap2 style-theme mt-50">
                            <div class="checklist style4">
                                <ul>
                                    <li><img src="assets/img/icon/checkmark.svg" alt="img">Diverse business portfolio</li>
                                    <li><img src="assets/img/icon/checkmark.svg" alt="img">Trusted by communities nationwide</li>
                                    <li><img src="assets/img/icon/checkmark.svg" alt="img">Excellence through innovation</li>
                                    <li><img src="assets/img/icon/checkmark.svg" alt="img">Commitment to sustainability</li>
                                </ul>
                            </div>
                            <div class="call-btn">
                                ...
                                <div class="btn-content">
                                    ...
                                    <span class="btn-text"><a class="text-theme" href="tel:+880123456789">+880 123 456 789</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    Why Choose Us Area  
    ==============================-->
    <div class="why-sec-1 overflow-hidden space bg-title-dark">
            ...
            <div class="row justify-content-lg-between align-items-center">
                <div class="col-lg-6">
                    <div class="title-area">
                        <h2 class="sec-title text-white">Why Choose Century Group?</h2>
                        <p class="text-light">With more than three decades of experience across real estate, hospitality, aviation, finance, and consumer services, Century Group has become one of Bangladesh’s most trusted and diversified conglomerates. Our strength lies in delivering sustainable projects, innovative solutions, and long-term value for our clients, investors, and communities.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
