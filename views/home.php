    ...
    <div class="th-hero-wrapper hero-2" id="hero">
                            ...
                            <div class="row gx-60 gy-50">
                                <div class="col-xl-5">
                                    <div class="hero-thumb2-1">
                                        <img src="assets/img/hero/real-estate.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-7">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-inner">
                            <div class="row gx-60 gy-50">
                                <div class="col-xl-5">
                                    <div class="hero-thumb2-1">
                                        <img src="assets/img/hero/hotel.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-7">
                                    <div class="hero-style2">
                                        <h1 class="hero-title">
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                                Luxury, Comfort, and </span>
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.5s">
                                                Timeless Hospitality </span>
                                        </h1>
                                        <p class="hero-text" data-ani="slideinup" data-ani-delay="0.6s">
                                            Offering world-class stays that blend luxury with warm Bangladeshi hospitality.
                    ...
                    <div class="swiper-slide">
                        <div class="hero-inner">
                            <div class="row gx-60 gy-50">
                                <div class="col-xl-5">
                                    <div class="hero-thumb2-1">
                                        <img src="assets/img/hero/garments.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-7">
                                    <div class="hero-style2">
                                        <h1 class="hero-title">
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                                Weaving Quality, </span>
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.5s">
                                                Dressing the World </span>
                                        </h1>
                                        <p class="hero-text" data-ani="slideinup" data-ani-delay="0.6s">
                                            With state-of-the-art facilities, we produce high-quality garments trusted by global brands.
                    ...
                    <div class="swiper-slide">
                        <div class="hero-inner">
                            <div class="row gx-60 gy-50">
                                <div class="col-xl-5">
                                    <div class="hero-thumb2-1">
                                        <img src="assets/img/hero/parks.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-7">
                                    <div class="hero-style2">
                                        <h1 class="hero-title">
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                                Creating Joy, </span>
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.5s">
                                                One Experience at a Time </span>
                                        </h1>
                                        <p class="hero-text" data-ani="slideinup" data-ani-delay="0.6s">
                                            Family-friendly entertainment and recreation spaces built to inspire joy.
                    ...
                    <div class="swiper-slide">
                        <div class="hero-inner">
                            <div class="row gx-60 gy-50">
                                <div class="col-xl-5">
                                    <div class="hero-thumb2-1">
                                        <img src="assets/img/hero/airways.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-7">
                                    <div class="hero-style2">
                                        <h1 class="hero-title">
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.4s">
                                                Connecting Horizons, </span>
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.5s">
                                                Inspiring Journeys </span>
                                        </h1>
                                        <p class="hero-text" data-ani="slideinup" data-ani-delay="0.6s">
                                            Connecting people and businesses through safe, reliable, and efficient air travel.
                    ...
                    <div class="swiper-slide">
                        <div class="hero-inner">
                            <div class="row gx-60 gy-50">
                                <div class="col-xl-5">
                                    <div class="hero-thumb2-1">
                                        <img src="assets/img/hero/finance.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-7">
                                    <div class="hero-style2">
                                        <h1 class="hero-title">
                                            ...
                                            <span class="title1" data-ani="slideinup" data-ani-delay="0.5s">
                                                Securing Futures </span>
                                        </h1>
                                        <p class="hero-text" data-ani="slideinup" data-ani-delay="0.6s">
                                            Innovative financial solutions designed to empower growth and stability.
                    ...
                    <div class="slider-area hero-slider-thumb-wrap">
                        <div class="swiper th-slider hero-grid-thumb" data-slider-options='{"effect":"slide","loop":false,"slidesPerView":"3"}'>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="assets/img/hero/real-estate.jpg" alt="Image">
                                        <span class="slider-number">Real Estate</span>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="assets/img/hero/hotel.jpg" alt="Image">
                                        <span class="slider-number">Hotels</span>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="assets/img/hero/garments.jpg" alt="Image">
                                        <span class="slider-number">Garments</span>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="assets/img/hero/parks.jpg" alt="Image">
                                        <span class="slider-number">Parks</span>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="assets/img/hero/airways.jpg" alt="Image">
                                        <span class="slider-number">Airways</span>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img">
                                        <img src="assets/img/hero/finance.jpg" alt="Image">
                                        <span class="slider-number">Finance</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="about-tag">
            <div class="about-experience-tag">
                <span class="circle-title-anime"></span>
            </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6">
                    <div class="title-area">
                        <h2 class="sec-title">Our Industries</h2>
                        <p class="sec-text">Since 1998, CENTRUY GROUP has been building a legacy of trust and innovation in Bangladesh.  
                                            From real estate and hospitality to garments, parks, airways, foods, and finance—our mission is to create value, 
                                            deliver excellence, and shape a brighter future for our communities and partners. </p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style2">
                            ...
                            <div class="service-img img-shine">
                                <img src="assets/img/service/hotel.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="service-card style2">
                            ...
                            <p class="box-text">We create secure and rewarding investment opportunities across industries, 
                                empowering growth and building lasting financial value for our partners.</p>
                            <div class="service-img img-shine">
                                <img src="assets/img/service/investments.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-xxl-6 col-xl-7 col-lg-6">
                    <div class="title-area text-lg-start text-center">
                        <h2 class="sec-title text-white">Discover Our Projects</h2>
                        <p class="sec-text text-white">
                            Showcasing a diverse portfolio of developments across real estate, hospitality, garments, leisure, foods, airways, and finance.  
                            Each project reflects our commitment to excellence, innovation, and long-term value creation.
                        </p>
                    </div>
                </div>
                <div class="col-auto">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                <div class="portfolio-img img-shine" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                                    <img src="assets/img/project/kuakata.jpg" alt="project image">
                                    <div class="portfolio-card-shape">
                                        <img src="assets/img/project/kuakata.jpg" alt="img">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="property-details.html">Kuakata Resorts</a></h3>
                                    <p class="portfolio-text">We are a real estate firm with over 20 years of expertise, and our main goal is to provide amazing locations to our partners and clients.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="property-details.html">Century Gold Coast</a></h3>
                                    <p class="portfolio-text">We are a real estate firm with over 20 years of expertise, and our main goal is to provide amazing locations to our partners and clients.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style2">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="property-details.html">Century Housing Projects</a></h3>
                                    <p class="portfolio-text">We are a real estate firm with over 20 years of expertise, and our main goal is to provide amazing locations to our partners and clients.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-center">
                <div class="col-xxl-6 col-lg-7">
                    <div class="title-area text-lg-start text-center">
                        ...
                        <p class="sec-text text-white">Our leadership team drives innovation across real estate, hospitality, airways, textiles, and finance, ensuring sustainable growth and excellence.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                ...
                <div class="row justify-content-lg-between justify-content-center align-items-center">
                    <div class="col-xxl-6 col-lg-7">
                        <div class="title-area text-lg-start text-center">
                            ...
                            <p>Century Group is headquartered in Dhaka with offices in Kuakata. Reach us for real estate, hospitality, finance, and other services.</p>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="sec-btn">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="about-contact-grid">
                        ...
                        <div class="about-contact-details">
                            ...
                            <p class="about-contact-details-text">Kha-225, Progati Sarani, Merul, Badda, East Gulshan</p>
            ...
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-xl-5">
                    <div class="title-area mb-32">
                        ...
                        <p class="sec-text">Century Group is a leading Bangladeshi conglomerate with ventures in real estate, hospitality, airways, finance, textiles, and more.</p>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="page-single bg-title-dark">
                        <div class="page-img mb-30">
                            <img class="w-100 rounded-20" src="assets/img/project/kuakata.jpg" alt="portfolio Image">
                        </div>
